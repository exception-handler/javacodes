...
public class ShoppingCart {
	...
	static {
		systemCart.add(new Item(101, 1000, "jeaqns"));
		systemCart.add(new Item(102, 1500, "Tshirt"));
		systemCart.add(new Item(103, 1300, "shoes"));
		systemCart.add(new Item(104, 1400, "shorts"));
	}
